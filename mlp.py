...
from loadData import saveResult
...
class MLP(object):
	...
	def __init__(self,
		...
		self.errors = self.layers[-1].negative_log_likelihood
...
def test_mlp(
	...
	saveResult(test_preds,'nn_dropout.csv');
...
if __name__ == '__main__':
	...
	# on top layer, since it is always 9-way Softmax
